...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experience.start_year'
        db.alter_column(u'linkedin_experience', 'start_year', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Experience.start_year'
        raise RuntimeError("Cannot reverse this migration. 'Experience.start_year' and its values cannot be restored.")
