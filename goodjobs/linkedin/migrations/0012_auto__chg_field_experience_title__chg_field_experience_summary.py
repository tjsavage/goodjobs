...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experience.title'
        db.alter_column(u'linkedin_experience', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Experience.summary'
        db.alter_column(u'linkedin_experience', 'summary', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Experience.title'
        raise RuntimeError("Cannot reverse this migration. 'Experience.title' and its values cannot be restored.")

        # Changing field 'Experience.summary'
        db.alter_column(u'linkedin_experience', 'summary', self.gf('django.db.models.fields.TextField')(default=''))
