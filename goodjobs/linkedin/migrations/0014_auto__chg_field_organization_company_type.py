...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.company_type'
        db.alter_column(u'linkedin_organization', 'company_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Organization.company_type'
        raise RuntimeError("Cannot reverse this migration. 'Organization.company_type' and its values cannot be restored.")
